...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_dataStructure_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/dataStructure.js */ \"./src/modules/dataStructure.js\");\n/* harmony import */ var _modules_dynamic_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dynamic.js */ \"./src/modules/dynamic.js\");\n/* harmony import */ var _modules_localStorage_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/localStorage.js */ \"./src/modules/localStorage.js\");\n/* harmony import */ var _modules_render_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/render.js */ \"./src/modules/render.js\");\n/* harmony import */ var _modules_variables_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/variables.js */ \"./src/modules/variables.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_4__.scoresInputBtn.addEventListener('click', () => {\r\n  const inputName = document.querySelector('.input-name').value;\r\n  const inputNumber = document.querySelector('.input-number').value;\r\n  if (inputName !== '' && inputNumber !== '') {\r\n    _modules_dataStructure_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dataStructure.push({ name: inputName, score: inputNumber });\r\n    (0,_modules_render_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\r\n    (0,_modules_localStorage_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\r\n  }\r\n});\r\n\r\n_modules_variables_js__WEBPACK_IMPORTED_MODULE_4__.scoresRefresh.addEventListener('click', () => {\r\n  _modules_dataStructure_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dataStructure = [];\r\n  (0,_modules_render_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])();\r\n});\r\n\r\nwindow.addEventListener('load', () => {\r\n  if (localStorage.getItem('scores')) {\r\n    _modules_dataStructure_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dataStructure = JSON.parse(localStorage.getItem('scores'));\r\n  }\r\n  for (let i = 0; i < _modules_dataStructure_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dataStructure.length; i += 1) {\r\n    const newScore = _modules_dataStructure_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].dataStructure[i];\r\n    _modules_dynamic_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addNewScore(newScore.name, newScore.score);\r\n  }\r\n});\r\n\r\nconst createNewGame = async () => {\r\n  const newGame = await fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games', {\r\n  method: \"POST\",\r\n  headers: {\r\n    'Content-Type': 'application/json',\r\n  },\r\n  body: JSON.stringify(\r\n    { \r\n\t    name: \"VitorGaming\" \r\n    })\r\n}).then((data) => {\r\n  return data.json();\r\n}).then((data) => {\r\n  return data.result.split(' ')[3]\r\n})\r\nreturn newGame\r\n}\r\n\r\nconst createNewScore = async () => {\r\n  const newgame = await createNewGame();\r\n  console.log('1', newgame)\r\n  const newScore = await fetch(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${newgame}/scores/`, {\r\n  method: \"POST\",\r\n  headers: {\r\n    'Content-Type': 'application/json',\r\n  },\r\n  body: JSON.stringify(\r\n    { \r\n      user: \"John Doe\",\r\n      score: 42\r\n    })\r\n  }).then((data) => {\r\n    return data.json();\r\n  }).then((data) => {\r\n    console.log(\"2\", data)\r\n  })\r\nreturn newScore\r\n}\r\n\r\nconst refresh = async () => {\r\n  const refreshBtn = await fetch(`https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/${newgame}/scores/`, {\r\n    method: \"GET\",\r\n    headers: {\r\n      'Content-Type': 'application/json',\r\n      Accept: 'application/json',\r\n    },\r\n  }).then((data) => {\r\n    return data.json()\r\n  })\r\n}\r\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
